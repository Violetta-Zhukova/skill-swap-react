  ...
  return (
    <div style={{ padding: '20px' }}>
      ...
      <p style={{ color: '#666', marginBottom: '20px' }}>
        Проверка работы Redux Toolkit слайса. Данные загружаются из <code>public/db/users.json</code>
      </p>
      ...
      <div style={{ marginBottom: '10px', color: '#666' }}>
        Показано: <strong>{filteredUsers.length}</strong> из {stats.total} пользователей
...
const UserCard: React.FC<{ 
  ...
  <div 
    ...
    style={{
      ...
      cursor: 'pointer',
      transition: 'all 0.2s',
      boxShadow: isSelected ? '0 4px 8px rgba(33, 150, 243, 0.2)' : '0 2px 4px rgba(0,0,0,0.1)'
    }}
  >
